...
questions = ["Convert *DDR1 100 MHz* Memory Clock Speed to I/O Bus Clock Speed", "Convert *DDR1 100 MHz* I/O Bus Clock Speed to DDR Speed", "Convert *DDR-200 DDR1* Speed to Transfer per Second", "Convert *DDR1 200 Million* Transfers per Second to Transfer Rate", "Convert *DDR1 1,600 MB/s* Transfer Rate to Module Name", "Convert *DDR1 PC1-1600* Module Name to Transfer Rate", "Convert *DDR1 1,600 MB/s* Transfer Rate to Transfers per Second", "Convert *DDR1 200 Million* Transfers per Second to DDR Speed", "Convert *DDR1-200 DDR* Speed to I/O Bus Clock Speed", "Convert *DDR1 100 MHz* I/O Bus Clock Speed to Memory Clock Speed", "Convert *DDR2 100 MHz* Memory Clock Speed to I/O Bus Clock Speed", "Convert *DDR2 200 MHz* I/O Bus Clock Speed to DDR Speed", "Convert *DDR2-400 DDR2* Speed to Transfer per Second", "Convert *DDR2 400 Million* Transfers per Second to Transfer Rate", "Convert *DDR2 3,200 MB/s* Transfer Rate to Module Name", "Convert *DDR2 PC2-3200* Module Name to Transfer Rate", "Convert *DDR2 3,200 MB/s* Transfer Rate to Transfers per Second", "Convert *DDR2 400 Million* Transfers per Second to DDR Speed", "Convert *DDR2-400 DDR* Speed to I/O Bus Clock Speed", "Convert *DDR2 200 MHz* I/O Bus Clock Speed to Memory Clock Speed", "Convert *100 MHz DDR3* Memory Clock Speed to I/O Bus Clock Speed", "Convert *DDR3 400 MHz* I/O Bus Clock Speed to DDR Speed", "Convert *DDR-800 DDR3* Speed to Transfer per Second", "Convert *DDR3 800 Million* Transfers per Second to Transfer Rate", "Convert *DDR3 6,400 MB/s* Transfer Rate to Module Name", "Convert *DDR3 PC3-6400* Module Name to Transfer Rate", "Convert *DDR3 6,400 MB/s* Transfer Rate to Transfers per Second", "Convert *DDR3 800 Million* Transfers per Second to DDR Speed", "Convert *DDR3-800 DDR* Speed to I/O Bus Clock Speed", "Convert *DDR3 400 MHz* I/O Bus Clock Speed to Memory Clock Speed"]

correct_choices = ["100 MHz", "DDR1-200", "200 Million", "1,600 MB/s", "PC1-1600", "1,600 MB/s", "200 Million", "DDR1-200", "100 MHz", "100 MHz", "200 MHz", "DDR2-400", "400 Million", "3,200 MB/s", "PC2-3200", "3,200 MB/s", "400 Million", "DDR2-400", "200 MHz", "100 MHz", "400 MHz", "DDR3-800", "800 Million", "6,400 MB/s", "PC3-6400", "6,400 MB/s", "800 Million", "DDR3-800", "400 MHz", "100 MHz"]
