...
#################################################################################
"Give user full priviledges, group read & write, and other read for 'example_python.py' with symbolic notation"
	"sudo chmod u=r,g=rwx,o=rwx example_python.py" 

"Give user full priviledges, group read & write, and other read for 'example_python.py' with octal permissions notation"
	"chmod 477 example_python.py"
