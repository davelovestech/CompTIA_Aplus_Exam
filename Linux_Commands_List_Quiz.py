...
correct_choices = ["sudo chmod u=rwx,g=rw,o=r example_python.py", "chmod 764 example_python.py", "ls", "ls -l", "mkdir duck", "cd duck", "cd ../", "mv example_python.py duck", "cd /", "pwd", "cp python_test.py dis.k", "rm python_test.py", "rm -r duck", "dd if=/dev/sda of=/dev/sdb", "dd if=/dev/sda of=/home/duck.img", "dd if/home/duck.img of=/dev/sda", "sudo chown mysql dis.k", "ps -e", "ps -e | more", "apt-get install wireshark", "sudo apt-get install wireshark", "su", "cat python.py", "vi python.py", "grep test python.py", "ifconfig", "iwconfig", "sudo killall VirtualBox", "traceroute 8.8.8.8", "sudo touch /forcefsck", "sudo rsync -azvh /home/folder1 /home/folder2"]
